...
<script type="text/javascript">
		...
		$(document).ready(
				...
				// alternate method listed below
					$("#getVolunteerDtlsQ").click(
							function(){
								var queryMap = {"query" :"SELECT VOLUNTEERID as VolunteerID, VOLUNTEER_NAME as VolunteerName, RES_ADDRESS as ResidentialAddress FROM VOLUNTEER_DETAILS"};
					...
					$("#getVolunteerDtls").click(function(){
						...
						if(nameEntered == null){
						 ...
						 var queryMap = {"givenName": nameEntered,"action":"getVolunteerDtls"};
						fetchVolunteerDetails($(this), queryMap);
					});
...
<body>
		...
		<input type="button" name="getVolunteerDtlsQ" id="getVolunteerDtlsQ"
			...
			<p/>
			<input type = "text" name="txtGivenName" id="txtGivenName"/> <input type="button"  name="getVolunteerDtls"  id="getVolunteerDtls" value="Get Volunteer Details">
